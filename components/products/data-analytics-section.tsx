...
export function DataAnalyticsSection() {
  return (
    <>
    <div style={{ backgroundImage: 'url(/products/data-analytics.webp)'}} className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-lg mb-8 bg-cover bg-center bg-no-repeat">
    </div>
